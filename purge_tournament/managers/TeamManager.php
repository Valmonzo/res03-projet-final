...
class TeamManager extends AbstractManager
{
    ...
    public function insertTeam(Team $team): void
    {
        $query = $this->db->prepare(
            "INSERT INTO team (`id`, `name`, `player_one`, `player_two`, `player_three`, `player_four`, `sub_player`, `logo`, `coach` ) VALUES(NULL, :name, :player_one, :player_two, :player_three, :player_four, :sub_player, :logo, :coach)"
        );
    ...
    {
        $query = $this->db->prepare(
            "UPDATE team SET  name = :name , player_one = :player_one, player_two = :player_two, player_three = :player_three, player_four = :player_four, sub_player = :sub_player, logo = :logo, coach = :coach WHERE id = :id"
        );
        $parameters = [
            "id" => $team->getId(),
            "name" => $team->getName(),
