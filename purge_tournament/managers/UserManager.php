...
class UserManager extends AbstractManager
{
    ...
    {
        $query = $this->db->prepare('INSERT INTO user (`id`, `email`, `username`, `password`) VALUES(NULL, :email, :username, :password)');
    ...
    {
        $query = $this->db->prepare('UPDATE user SET email = :email, username = :username,  password = :password WHERE id = :id ');
        $parameters = [
            'id' => $user->getId(),
            'email' => $user->getEmail(),
            'username' => $user->getUsername(),
